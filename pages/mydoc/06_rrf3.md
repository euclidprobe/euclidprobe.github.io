...
RepRap Firmware version 3.x can utilize gcode meta commands, which are highly recommended to perform logic checks to determine whether or not the probe is deployed.  
...
The most up-to-date macros are in the <a href="https://github.com/nionio6915/Euclid_Probe/tree/main/Firmware_Examples/Duet" target="blank">github repository</a>. 
